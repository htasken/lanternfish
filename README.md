...
An example report generated by LanternFish is available in the `example_reports` directory. It was generaed like this: 

![Demo](https://github.com/htasken/lanternfish/blob/main/example_reports/screenshot_lanterfish.png)
